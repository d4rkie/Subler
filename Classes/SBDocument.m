...
- (void)windowControllerDidLoadNib:(NSWindowController *) aController
{
    ...
    languages = [[NSArray arrayWithObjects:  @"Unknown", @"Japanese", @"English", @"French", @"German", @"Italian",@"Dutch", @"Swedish", @"Spanish", @"Danish", @"Portuguese", @"Norwegian", @"Hebrew", @"Arabic", @"Finnish", @"Greek, Modern", @"Icelandic", @"Maltese", @"Turkish", @"Croatian", @"Chinese", @"Urdu", @"Hindi", @"Thai", @"Korean", @"Lithuanian", @"Polish", @"Hungarian", @"Estonian", @"Latvian", @"Northern Sami", @"Faroese", @"Persian", @"Romanian", @"Russian", @"Irish", @"Albanian", @"Bulgarian", @"Czech", @"Slovak", @"Slovenian", nil] retain];
